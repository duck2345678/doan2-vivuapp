...
import com.example.vnuguideapp.entity.PostAndInteractions.PostLocation;
import com.example.vnuguideapp.entity.PostAndInteractions.PostMedia;
import com.example.vnuguideapp.entity.PostAndInteractions.SavedPost;
...
import com.example.vnuguideapp.repository.PostAndInteractions.SavedPostRepository;
        ...
        private PostResponse buildPostResponse(Post post, Boolean isLiked) {
                ...
                return PostResponse.builder()
                                ...
                                .locations(post.getPostLocations().stream()
                                                .map(location -> com.example.vnuguideapp.dto.reponse.PostAndInteractions.PostLocationResponse.builder()
                                                                .id(location.getId())
