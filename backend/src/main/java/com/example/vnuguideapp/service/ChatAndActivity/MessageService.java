...
import com.example.vnuguideapp.dto.event.ChatAndActivity.AckEvent;
import com.example.vnuguideapp.dto.event.ChatAndActivity.ChatMessageEvent;
import com.example.vnuguideapp.dto.event.ChatAndActivity.TypingEvent;
...
import com.example.vnuguideapp.dto.reponse.ChatAndActivity.ReadReceiptResponse;
import com.example.vnuguideapp.dto.request.ChatAndActivity.ChatSendPayload;
...
import com.example.vnuguideapp.dto.event.ChatAndActivity.MessageReadEvent;
...
import com.example.vnuguideapp.exception.exceptionImpl.MessageAlreadyDeletedException;
...
import com.example.vnuguideapp.service.AccountAndAuthorization.UserProfileCacheService;
...
public class MessageService {
        ...
        private String getSenderAvatarUrl(Long userId) {
                return userProfileRepository.findByUserId(userId)
                                .map(com.example.vnuguideapp.entity.AccountAndAuthorization.UserProfile::getAvatarUrl)
                                .orElse(null);
        }
        ...
        public void acceptMessageRequest(User user, String conversationId) {
                ...
                messagingTemplate.convertAndSendToUser(
                                user.getId().toString(),
                                "/queue/events",
                                com.example.vnuguideapp.dto.event.ChatAndActivity.ConversationUpgradedEvent.builder()
                                                .conversationId(conversationId)
                                                .newStatus(ParticipantStatus.INBOX)
                                                .reason(com.example.vnuguideapp.dto.event.ChatAndActivity.ConversationUpgradedEvent.UpgradeReason.MESSAGE_REQUEST_ACCEPTED)
                                                .build());
        }
