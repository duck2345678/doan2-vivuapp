...
public class ConversationService {
    ...
    public String leaveConversation(User user, String conversationId) {
        ...
        if (conversation.getType() == com.example.vivuapp.enums.ConversationType.DIRECT) {
            // DIRECT conversation: Soft delete - mark as DELETED
            participant.setStatus(com.example.vivuapp.enums.ParticipantStatus.DELETED);
            ...
            if (conversation.getType() == com.example.vivuapp.enums.ConversationType.CHANNEL) {
