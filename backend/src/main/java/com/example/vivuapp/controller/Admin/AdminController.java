package com.example.vivuapp.controller.Admin;

import com.example.vivuapp.dto.reponse.*;
import com.example.vivuapp.dto.request.*;
import com.example.vivuapp.service.Admin.AdminService;
...
public class AdminController {
  ...
  public ResponseEntity<List<com.example.vivuapp.dto.reponse.ReportTypeResponse>> getReportTypes(
      @RequestParam(required = false) String search) {
    return ResponseEntity.ok(adminService.getReportTypes(search));
  }

  @PostMapping("/report-types")
  public ResponseEntity<com.example.vivuapp.dto.reponse.ReportTypeResponse> createReportType(
      @RequestBody @Valid com.example.vivuapp.dto.request.ReportTypeRequest request) {
    return ResponseEntity.ok(adminService.createReportType(request));
  }

  @PutMapping("/report-types/{id}")
  public ResponseEntity<com.example.vivuapp.dto.reponse.ReportTypeResponse> updateReportType(
      @PathVariable Long id,
      @RequestBody @Valid com.example.vivuapp.dto.request.ReportTypeRequest request) {
